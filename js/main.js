...
let campoNome = document.querySelector("#campNome");
let campoEmail = document.querySelector("#campEmail");
let campoCidade = document.querySelector("#campCidade");
let campoEstado = document.querySelector("#campEstado");
let dadosTabela = document.querySelector("tbody");
let popUpCadatro = document.querySelector("#alertaCadastro");
